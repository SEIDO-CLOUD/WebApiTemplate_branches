...
5. Run AppWebApi with or without debugger
...
6. Use endpoint Admin/SeedUsers to seed users into the the database

7. Use endpoint Guest/LoginUser to login as sysadmin1
{
...
10. As sysadmin you can now use and play with all endpoints
