...
public interface IZooService {
    ...
    public Task<UsrInfoDto> SeedUsersAsync(int nrOfUsers, int nrOfSuperUsers);
    ...
    public Task<ResponseItemDto<ICreditCard>> ReadCreditCardAsync(Guid id, bool flat, bool decrypt);
